...
```bash
$ ./tools/toolchain/dbuild ninja build/debug/test/boost/rest_authenticator_test                  # to build test suite
$ ./tools/toolchain/dbuild build/debug/test/boost/rest_authenticator_test                        # to manually run test suite
$ ./tools/toolchain/dbuild build/debug/test/boost/rest_authenticator_test --run_test=<test_case> # to replay a specific test case
$ ./tools/toolchain/dbuild ./test.py --no-parallel-cases --mode debug rest_authenticator         # to run test suite via scylla test facility
```